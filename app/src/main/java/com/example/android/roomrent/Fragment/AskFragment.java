...
import com.example.android.roomrent.Adapter.AskPostDatumAdapter;
 ...
 */
public class AskFragment extends Fragment implements PaginationAdapterCallback,ItemClickListener {

    private final static String TAG = AskFragment.class.getName();


    AskPostDatumAdapter adapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        adapter = new AskPostDatumAdapter(rootView.getContext(),this);
